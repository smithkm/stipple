...
public class ToroidalDistanceTheoryTest {
	...
	@DataPoints
	public static Coordinate[] points() {
		return new Coordinate[] { new Coordinate(0.0, 0.0), new Coordinate(3.0, 4.0), new Coordinate(3.0, 0.0),
				new Coordinate(0.0, 4.0), new Coordinate(1.0, 1.0), new Coordinate(-1.5, 2.0), new Coordinate(1.5, 2.0),
				new Coordinate(4.5, 2.0), new Coordinate(-1.5, -2.0), new Coordinate(1.5, -2.0),
				new Coordinate(4.5, -2.0), new Coordinate(-1.5, 6.0), new Coordinate(1.5, 6.0),
				new Coordinate(4.5, 6.0), new Coordinate(2.9, 3.9), new Coordinate(0.1, 0.1), new Coordinate(1.5, 2.0) // duplicate
		};
	}
