...
public class TestSVG {
	...
	public static void svgOut(String fileName, int width, int height, Consumer<PrintStream> defs,
			Consumer<PrintStream> body) {
	...
	public static void svgOut(PrintStream out, int width, int height, Consumer<PrintStream> defs,
			Consumer<PrintStream> body) {
