...
/**
 * Distance measured with toroidal topology. The top edge connects to the
 * bottom, and the left to the right. Otherwise everything is treated as being
 * flat. Points outside the envelope are treated as being on other 'instances'
 * of the tile.
 * 
